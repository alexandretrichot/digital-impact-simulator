...
export default function Socials(props: Props) {
  return <Section
    ...
    counters={<>
      <Counter title="Minutes passé par jours sur Instagram" description={''} value={props.instagramPics} onUpdate={value => props.onUpdateInstagram(value)} />
      <Counter title="Minutes passé par jours sur Snapchat" description={''} value={props.snapchatPics} onUpdate={value => props.onUpdateSnapchat(value)} />
    </>}
    footer={<>

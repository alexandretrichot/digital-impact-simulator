	...
	return (
        ...
        services en ligne.
				...
				<div className="similes">
					<Simile title={`${Math.round((totalKwh * 365) / values.frigoPerYear)} frigos`} icon={fridgeIcon}>C'est l'équivalent en consommation energétique de {Math.round((totalKwh * 365) / values.frigoPerYear)} frigos par an.</Simile>
